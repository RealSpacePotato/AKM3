...
int main(int argc, char *argv[]) {
    ...
    int (*tests[])(void) = { test00, test01, test02, test03, test04, test05,  /* 0-15 are SPEC TESTS */
                             ...
                             test16, test17, test18, test19,                  /* 16-19 are STRESS TESTS */
                             test20, test21, test22, test23 };                /* 20-23 are GIVEN SPEC TESTS */
    ...
    if (strcmp(EMPTY_TEST, test_descriptions[test_num]) != 0) {
